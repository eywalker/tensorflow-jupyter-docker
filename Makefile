...
build:
	...
	sudo docker build --pull -f Dockerfile.cuda.v1.0.1 -t eywalker/tensorflow-jupyter:v1.0.1-cuda8.0-cudnn5 .
...
push:
	...
	sudo docker push eywalker/tensorflow-jupyter:v1.0.1-cuda8.0-cudnn5
